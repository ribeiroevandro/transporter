...
Route::get('/add/pagar' , 'PaymentController@add_money_pagar_api');

Route::get('/add/pagar/provider' , 'PaymentController@provider_add_money_pagar_api');

Route::post('/pagar/success/provider', 'PaymentController@provider_pagar_success');

Route::get('/flow/pagar' , 'PaymentController@flow_pagar_api');

Route::any('wallet/success', 'PaymentController@walletpaySuccessapi');
Route::any('/wallet/failure', 'PaymentController@walletpayCancelapi');
...
Route::post('/pagar/success', 'PaymentController@pagar_success');
Route::post('/pagar/flow', 'PaymentController@pagar_flow');
